    ...
    <section id='home' className="md:flex md:justify-between md:items-center md:h-full gap-16 py-10 ">
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          ...
          >
            <AnchorLink
            className="bg-gradient-rainblue text-deep-blue rounded-sm py-3 px-8 font-semibold hover:bg-blue hover:text-white transition duration-500"
            ...
            href='#contact'
            >
              <div className="bg-deep-blue hover:text-red transition duration-500 w-ful h-full flex items-center justify0center font-playfair px-10">
                Let's talk.
              </div>
            </AnchorLink>
          </motion.div>
